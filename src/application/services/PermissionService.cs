...
{
    public class PermissionService : BaseService1, IPermissionService
    {
        public PermissionService(IOptions<ConnectionStringList> connectionStrings) : base(connectionStrings)
        {
        }
